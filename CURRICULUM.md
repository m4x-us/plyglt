...
| B1 | 22/35 | 2,077 | ~9,450 | IN PROGRESS — 8 new grammar units added 2026-08-01 (subjunctive triggers ×3, hypotheticals, concession/contrast, cause/effect, purpose/result, formal register); 13 units still missing; the original 14 units are still thin (~32 cards/unit avg) and not yet expanded |
...
| **Total** | **85/125** | **10,685** | **~32,950** | ~32% of the way to the full target by card count |
